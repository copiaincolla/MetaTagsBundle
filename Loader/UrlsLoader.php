...
class UrlsLoader implements UrlsLoaderInterface
{
    ...
    /**
     * Get all the urls, generated by CopiaincollaMetaTagsBundle,
     * starting from the routes contained in the list of bundles
     * specified by the user in configuration
     *
     * Return an associative array of (relative) paths organized by route name
     * es: $output = array(
     *         'homepage' => array([url]),
